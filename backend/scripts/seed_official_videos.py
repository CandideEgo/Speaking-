...
async def seed_video(entry: dict, force_update: bool = False) -> bool:
    ...
    async with async_session() as db:
        ...
        # Fetch subtitles
        print(f"  [SUBS] Fetching subtitles...")
        ...
        if subs:
            ...
            print(f"  [WARN] No subtitles found -- video will be ready but without subtitles")
