> **Frozen snapshot — 2026-09-19.** This was `.agent/state.md` before the knowledge-layer
> restructure. Kept for archaeology: the completed-milestone dump, the per-session changelog and
> the 2026-07/08 history that no longer belong in the forward-looking `state.md`.
> Not maintained, not checked, not held to today's links.
