...
This project is indexed by GitNexus as **Speaking-** (8124 symbols, 14671 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
