...
| [0019](0019-vocab-set-quick-sieve-loop.md) | 词汇学习闭环 — 视频集合 + 快速过筛（三态状态机） | Accepted |
| [0020](0020-storage-modes-and-takedown.md) | 内容存储三态与半自动下线（local / proxy / offline） | Accepted |
