      ...
      <div className="flex items-center gap-3">
        ...
        {speakingState === "idle" && (
          <button
            ...
            className="btn-primary !py-2 !bg-red-600 hover:!bg-red-700"
          >
            <Mic size={16} /> 录音
          </button>
        )}
        {speakingState === "listening" && (
          <button
            ...
            className="btn-primary !py-2 !bg-red-600 hover:!bg-red-700 animate-pulse"
          >
            <MicOff size={16} /> 停止
          </button>
        )}
      ...
      {speakingResult && speakingState === "result" && (
        <div className="mt-3 rounded-lg bg-navy p-4">
          ...
          <div className="mt-3 flex gap-2">
            <button
              onClick={reRecord}
              className="flex-1 btn-secondary-dark !py-2 text-xs justify-center"
            >
              再练一次
            </button>
            <button
